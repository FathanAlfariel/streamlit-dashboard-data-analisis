...
with st.sidebar:
    # Title
    st.title("Fathan Alfariel Adhyaksa")
...
with tab3:
    ...
    with st.expander("See Explanation"):
        st.write('Berdasarkan grafik yang telah dibuat diatas, terlihat bahwa jumlah pelanggan lebih banyak terdapat di wilayah tenggara dan selatan.')

st.caption('Copyright (C) Fathan Alfariel Adhyaksa 2024')
